                ...
                <form method="post" action="{{route('task.store')}}" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <input class="form-control" style="width: 100%; height:30px;" type="text"  name="requested_completion" id="requested_completion" onfocus="(this.type='date')" onblur="(this.type='text')" placeholder="Requested Completion Date" value="{{ $task->requested_completion }}">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <select class="select2 pl-1 form-control" name="status" id="status" style="width: 100%; height:30px !important;">
                                        ...
                                        <option value="0" {{ ( "Pending" == $task->status) ? 'selected' : '' }} >Pending</option>
                                        <option value="1" {{ ( "Quoting" == $task->status) ? 'selected' : '' }}>Quoting</option>
                                        <option value="2" {{ ( "Awaiting Approval" == $task->status) ? 'selected' : '' }}>Awaiting Approval</option>
                                        <option value="3" {{ ( "Scheduled" == $task->status) ? 'selected' : '' }}>Scheduled</option>
                                        <option value="4" {{ ( "Complete" == $task->status) ? 'selected' : '' }}>Complete</option>
                                        <option value="5" {{ ( "Invoiced" == $task->status) ? 'selected' : '' }}>Invoiced</option>
                                        <option value="6" {{ ( "Cancelled" == $task->status) ? 'selected' : '' }}>Cancelled</option>
                                    </select>
