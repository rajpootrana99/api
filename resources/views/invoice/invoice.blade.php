                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="float-left">
                            ...
                            <p class="mb-0">{{ $invoice->entity->entity }}</p>
                    ...
                    <div class="col-md-6">
                        <div class="float-right">
                            ...
                            <p class="mb-0">{{ $invoice->task->site->site }}</p>
                            <p>{{ $invoice->task->site->site_address }}, {{ $invoice->task->site->suburb }}, {{ $invoice->task->site->state }}, {{ $invoice->task->site->post_code }}</p>
                        </div>
                    </div> <!--end col-->
                </div><!--end row-->
