            ...
            <form method="post" id="addContactForm">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <div class="row"><label for="mobile" class="col-sm-12 control-label">Mobile</label></div>
                                <div class="col-sm-12">
                                    <input class="form-control" style="width: 100%; height:30px;" type="number" name="mobile" id="mobile">
                                </div>
